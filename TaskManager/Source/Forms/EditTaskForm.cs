...
{
    public partial class EditTaskForm : RibbonForm {
        ...
        void InitValidationProvider() {
            dxValidationProvider1.SetValidationRule(teSubject, ValidationRulesUtils.RuleIsNotBlank);
        }
        void UpdateCaption() {
        ...
        void InitEditors() {
			EditorUtils.CreateTaskStatusImageComboBox(icbStatus.Properties);
			EditorUtils.InitPriorityComboBox(icbPriority.Properties);
        }
